...
\author{Milad~Awad% <-this % stops a space
	\thanks{Hochschule Bremen, mawad@stud.hs-bremen.de. Manuscript received February 20, 2026; revised TBD.}}

% The paper headers
%\markboth{Journal Name,~Vol.~X, No.~X, Month~Year}%
%{Awad \MakeLowercase{\textit{et al.}}: Comparative Analysis of Native vs. Cross-Platform Mobile Development}
